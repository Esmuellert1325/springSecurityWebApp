...
insert into users (email, first_name, last_name, password, last_login, birth_date) values ('admin@webapp.com', 'Main', 'Admin', '{noop}admin', current_date(), '2000-01-30')
...
insert into categories (category) values ('Thriller')
